...
$launcher = Join-Path $env:USERPROFILE ".kimi\skills\paper-spine-intake\scripts\launch_paperspine_ui.ps1"
...
LAUNCHER="$HOME/.kimi/skills/paper-spine-intake/scripts/launch_paperspine_ui.sh"
