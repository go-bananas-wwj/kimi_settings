...
**Personal skills live in agent-specific directories (`~/.config/agents/skills` for Kimi Code CLI, `~/.claude/skills` for Claude Code)**
...
**Visualizing for your human partner:** You can render skill flowcharts to SVG using graphviz if needed.
...
**Testing methodology:** See the skill creation checklist below for the complete testing methodology:
